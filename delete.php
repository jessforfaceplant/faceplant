<html>
	...
	<body>
		<div style="padding-top:20px;">
			<a class="wrapper" id="logo" onmouseover="this.innerHTML = 'FACEPLANT *~DELETE~*'" onmouseout="this.innerHTML = 'FACEPLANT ~*DELETE*~'" onclick="javascript:location.href='homepage.php'">FACEPLANT ~*DELETE*~</a>
