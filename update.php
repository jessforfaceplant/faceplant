<html>
	...
	<body>
		<div style="padding-top:20px;">
			<a class="wrapper" id="logo" onmouseover="this.innerHTML = 'FACEPLANT *~UPDATE~*'" onmouseout="this.innerHTML = 'FACEPLANT ~*UPDATE*~'" onclick="javascript:location.href='homepage.php'">FACEPLANT ~*UPDATE*~</a>
